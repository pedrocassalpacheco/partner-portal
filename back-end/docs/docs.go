...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "email": "support@partnerportal.com"
        },
        "license": {
            "name": "Apache 2.0",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AccountUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.PartnerRegistrationRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.Partner": {
            ...
            "properties": {
                ...
                "contacts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.PartnerContact"
                    }
                },
                "country": {
                    "type": "string"
        ...
        "models.PartnerContact": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "\"business\" or \"technical\"",
                    "type": "string"
                }
            }
        },
        "models.PartnerRegistrationRequest": {
            "type": "object",
            "required": [
                "aiExperience",
                "annualRevenue",
